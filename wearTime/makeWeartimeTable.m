function [wearTime,unWornTime,percentWorn,percentUnworn] = makeWeartimeTable()
...
wearTimeHeading = {'subjectID' 'Wear Time (minutes)'}; 
unWornTimeHeading = {'subjectID' 'unWorn Time (minutes)'}; 
